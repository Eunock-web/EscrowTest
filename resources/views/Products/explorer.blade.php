                ...
                <div class="product-card group">
                    <div class="card-img bg-slate-800">
                        @if($product->url_image)
                            <img src="{{ $product->url_image }}" alt="{{ $product->nom }}" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
                        @else
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-center justify-between mt-4">
                            ...
                            <a href="{{ route('product.show', $product->id) }}" class="btn-primary text-white text-xs px-4 py-2 rounded-lg font-medium">
                                Acheter
                            </a>
                        </div>
                    </div>
