    ...
    <nav class="fixed top-0 inset-x-0 z-50 border-b border-white/5 bg-[#09090f]/80">
        <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-8 text-sm text-slate-400">
                <a href="{{ route('explorer') }}" class="hover:text-white transition-colors">Explorer</a>
                <a href="#" class="hover:text-white transition-colors">Catégories</a>
                <a href="{{ route('creators') }}" class="hover:text-white transition-colors">Créateurs</a>
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="{{ route('register') }}" class="btn-primary text-sm text-white px-5 py-2 rounded-lg font-medium">Commencer</a>
            </div>
        </div>
    </nav>
